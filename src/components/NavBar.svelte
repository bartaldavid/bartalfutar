...
<nav
  class="fixed md:static md:flex-col md:justify-normal md:gap-5 md:w-auto md:m-10 md:mt-12 bottom-0 z-50 flex w-full justify-evenly py-3 font-light text-slate-700 backdrop-blur-3xl dark:text-slate-100"
>
